...
\begin{figure}[htp]
	...
	\subfigure[巴西] {
		\begin{minipage}{0.48\linewidth}
			\centering
			\includegraphics[width=7.0cm]{Brazil_SEIR.pdf}
		\end{minipage}
	}
	\subfigure[德国] {
		\begin{minipage}{0.48\linewidth}
			\centering
			\includegraphics[width=7.0cm]{Germany_SEIR.pdf}
		\end{minipage}
	}
	\\
	\subfigure[意大利] {
		\begin{minipage}{0.48\linewidth}
			\centering
			\includegraphics[width=7.0cm]{Italy_SEIR.pdf}
		\end{minipage}
	}
	\subfigure[俄罗斯] {
		\begin{minipage}{0.48\linewidth}
			\centering
			\includegraphics[width=7.0cm]{Russia_SEIR.pdf}
		\end{minipage}
	}
    \\
    \subfigure[英国] {
    	\begin{minipage}{0.48\linewidth}
    		\centering
    		\includegraphics[width=7.0cm]{UK_SEIR.pdf}
    	\end{minipage}
    }
    \subfigure[美国] {
    	\begin{minipage}{0.48\linewidth}
    		\centering
    		\includegraphics[width=7.0cm]{US_SEIR.pdf}
    	\end{minipage}
    }
	\caption{SEIR模型的模拟}
	\label{fig:SEIRfit}
